...
class Ui_ProjectFilesDialog(object):
  def setupUi(self, ProjectFilesDialog):
    ...
    ProjectFilesDialog.resize(479, 510)
    icon = QtGui.QIcon()
    ...
    self.stackedWidget = QtGui.QStackedWidget(ProjectFilesDialog)
    ...
    self.addToProjectButton = QtGui.QToolButton(self.page)
    ...
    self.removeFromProjectButton = QtGui.QToolButton(self.page)
    ...
    self.gridLayout_2.addLayout(self.hboxlayout2, 1, 0, 1, 1)
    ...
    self.okButton = QtGui.QPushButton(self.page)
