...
#
# Created: Mon Jan 17 14:55:30 2011
...
"}"))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 266, 398))
        self.scrollAreaWidgetContents.setObjectName(_fromUtf8("scrollAreaWidgetContents"))
        self.gridLayout = QtGui.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout.setMargin(0)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.imageViewer = ImageViewerLabel(self.scrollAreaWidgetContents)
        ...
        self.imageViewer.setObjectName(_fromUtf8("imageViewer"))
        self.gridLayout.addWidget(self.imageViewer, 0, 0, 1, 1)
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.formLayout_4.setWidget(0, QtGui.QFormLayout.SpanningRole, self.scrollArea)
        self.pageNumber = QtGui.QSpinBox(self.tab_2)
        self.pageNumber.setEnabled(False)
        self.pageNumber.setAccelerated(True)
        self.pageNumber.setMinimum(0)
        self.pageNumber.setMaximum(5000)
        self.pageNumber.setProperty(_fromUtf8("value"), 0)
        self.pageNumber.setObjectName(_fromUtf8("pageNumber"))
        self.formLayout_4.setWidget(3, QtGui.QFormLayout.FieldRole, self.pageNumber)
        self.pageNumberLabel = QtGui.QLabel(self.tab_2)
        self.pageNumberLabel.setObjectName(_fromUtf8("pageNumberLabel"))
        self.formLayout_4.setWidget(3, QtGui.QFormLayout.LabelRole, self.pageNumberLabel)
        self.pageDPI = QtGui.QSpinBox(self.tab_2)
        self.pageDPI.setEnabled(False)
        self.pageDPI.setAccelerated(True)
        self.pageDPI.setSuffix(_fromUtf8(""))
        self.pageDPI.setPrefix(_fromUtf8(""))
        self.pageDPI.setMinimum(0)
        self.pageDPI.setMaximum(2000)
        self.pageDPI.setProperty(_fromUtf8("value"), 0)
        self.pageDPI.setObjectName(_fromUtf8("pageDPI"))
        self.formLayout_4.setWidget(4, QtGui.QFormLayout.FieldRole, self.pageDPI)
        self.pageDPILabel = QtGui.QLabel(self.tab_2)
        self.pageDPILabel.setObjectName(_fromUtf8("pageDPILabel"))
        self.formLayout_4.setWidget(4, QtGui.QFormLayout.LabelRole, self.pageDPILabel)
        self.zoomFactorLabel = QtGui.QLabel(self.tab_2)
        self.zoomFactorLabel.setObjectName(_fromUtf8("zoomFactorLabel"))
        self.formLayout_4.setWidget(2, QtGui.QFormLayout.LabelRole, self.zoomFactorLabel)
        self.zoomFactor = QtGui.QSlider(self.tab_2)
        self.zoomFactor.setMaximum(10)
        self.zoomFactor.setSliderPosition(1)
        self.zoomFactor.setOrientation(QtCore.Qt.Horizontal)
        self.zoomFactor.setObjectName(_fromUtf8("zoomFactor"))
        self.formLayout_4.setWidget(2, QtGui.QFormLayout.FieldRole, self.zoomFactor)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pageNumber.setSpecialValueText(QtGui.QApplication.translate("MainWindow", "?", None, QtGui.QApplication.UnicodeUTF8))
        self.pageNumberLabel.setText(QtGui.QApplication.translate("MainWindow", "Page Number", None, QtGui.QApplication.UnicodeUTF8))
        self.pageDPI.setSpecialValueText(QtGui.QApplication.translate("MainWindow", "?", None, QtGui.QApplication.UnicodeUTF8))
        self.pageDPILabel.setText(QtGui.QApplication.translate("MainWindow", "Page DPI", None, QtGui.QApplication.UnicodeUTF8))
        self.zoomFactorLabel.setText(QtGui.QApplication.translate("MainWindow", "Zoom Factor", None, QtGui.QApplication.UnicodeUTF8))
...
from BookListWidget import BookListWidget, ImageViewerLabel
import resources_rc
