    ...
    def get_dpi(self):
        ...
        for page in self.pages:
            if (self.dpi is not None) and (page.dpi != self.dpi):
                ...
                utils.error("wrn: organizer.Book.analyze(): Page dpi is different from the previous page.")
                utils.error("wrn: organizer.Book.analyze(): If you encounter problems with minidjvu, this is probably why.")
            self.dpi = page.dpi
